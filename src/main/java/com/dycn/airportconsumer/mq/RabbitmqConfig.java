...
////            List<String> collect = ipLists.stream().filter(s -> !"10.142.61.10".equals(s) && !"10.142.61.3".equals(s) && !"10.142.61.2".equals(s)).collect(Collectors.toList());
//
//            ipLists.forEach(ip -> {
//                try {
...
//                    http2DeviceController.updateRepoSettings(HttpParameters.PERSONS, HttpParameters.USERNAME, HttpParameters.PASSWORD, 123,OperationType.REMOVE, null,obj,null);
//                } catch (Exception e) {
