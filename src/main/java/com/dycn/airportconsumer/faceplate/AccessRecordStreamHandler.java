package com.dycn.airportconsumer.faceplate;//package com.dycn.healthairport.faceplate;
//
...
//        List<GenericRecord> newRecords = AvroUtil.decodeCompatibility(schemaString, accessRecordResult.getSchema(), data);
