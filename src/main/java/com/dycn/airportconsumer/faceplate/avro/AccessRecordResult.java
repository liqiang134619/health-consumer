...
public class AccessRecordResult extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  @Deprecated public com.dycn.healthairport.faceplate.avro.AccessRecord accessRecord;
   ...
   */
  public AccessRecordResult(com.dycn.healthairport.faceplate.avro.AccessRecord accessRecord, String checkpoint) {
  ...
  public void put(int field$, Object value$) {
    switch (field$) {
    case 0: accessRecord = (com.dycn.healthairport.faceplate.avro.AccessRecord)value$; break;
   ...
   */
  public com.dycn.healthairport.faceplate.avro.AccessRecord getAccessRecord() {
    return accessRecord;
  }
   ...
   */
  public void setAccessRecord(com.dycn.healthairport.faceplate.avro.AccessRecord value) {
   ...
   */
  public static com.dycn.healthairport.faceplate.avro.AccessRecordResult.Builder newBuilder() {
    return new com.dycn.healthairport.faceplate.avro.AccessRecordResult.Builder();
  }
   ...
   * @return A new AccessRecordResult RecordBuilder
   */
  public static com.dycn.healthairport.faceplate.avro.AccessRecordResult.Builder newBuilder(com.dycn.healthairport.faceplate.avro.AccessRecordResult.Builder other) {
    return new com.dycn.healthairport.faceplate.avro.AccessRecordResult.Builder(other);
  }
   ...
   * @return A new AccessRecordResult RecordBuilder
   */
  public static com.dycn.healthairport.faceplate.avro.AccessRecordResult.Builder newBuilder(com.dycn.healthairport.faceplate.avro.AccessRecordResult other) {
    return new com.dycn.healthairport.faceplate.avro.AccessRecordResult.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<AccessRecordResult>
    ...
    private com.dycn.healthairport.faceplate.avro.AccessRecord accessRecord;
    private com.dycn.healthairport.faceplate.avro.AccessRecord.Builder accessRecordBuilder;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.dycn.healthairport.faceplate.avro.AccessRecordResult.Builder other) {
      super(other);
      ...
      if (other.hasAccessRecordBuilder()) {
        this.accessRecordBuilder = com.dycn.healthairport.faceplate.avro.AccessRecord.newBuilder(other.getAccessRecordBuilder());
      }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.dycn.healthairport.faceplate.avro.AccessRecordResult other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.accessRecord)) {
        this.accessRecord = data().deepCopy(fields()[0].schema(), other.accessRecord);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.dycn.healthairport.faceplate.avro.AccessRecordResult.Builder setAccessRecord(com.dycn.healthairport.faceplate.avro.AccessRecord value) {
     ...
     * @return This builder.
     */
    public com.dycn.healthairport.faceplate.avro.AccessRecord.Builder getAccessRecordBuilder() {
      if (accessRecordBuilder == null) {
        if (hasAccessRecord()) {
          setAccessRecordBuilder(com.dycn.healthairport.faceplate.avro.AccessRecord.newBuilder(accessRecord));
        } else {
          setAccessRecordBuilder(com.dycn.healthairport.faceplate.avro.AccessRecord.newBuilder());
        }
      }
     ...
     * @return This builder.
     */
    public com.dycn.healthairport.faceplate.avro.AccessRecordResult.Builder setAccessRecordBuilder(com.dycn.healthairport.faceplate.avro.AccessRecord.Builder value) {
      clearAccessRecord();
    ...
    /**
      ...
      * @return This builder.
      */
    public com.dycn.healthairport.faceplate.avro.AccessRecordResult.Builder clearAccessRecord() {
      accessRecord = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.dycn.healthairport.faceplate.avro.AccessRecordResult.Builder setCheckpoint(String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.dycn.healthairport.faceplate.avro.AccessRecordResult.Builder clearCheckpoint() {
      checkpoint = null;
    ...
    public AccessRecordResult build() {
      try {
        ...
        if (accessRecordBuilder != null) {
          ...
          record.accessRecord = fieldSetFlags()[0] ? this.accessRecord : (com.dycn.healthairport.faceplate.avro.AccessRecord) defaultValue(fields()[0]);
        }
